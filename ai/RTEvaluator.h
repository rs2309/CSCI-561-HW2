...
//        int stabilityScore;
    ...
    static EvaluationResult evaluateBoard(const Reversi board, int player) {
...
private:
    static int calculateIslandScore(const Reversi& board, int player, int playerDiscCount, int opDiscCount) {
